...
The first line of input contains an integer T, denoting the number of test cases. Then T test cases
 follow. First line of each test case contains an integer N denoting the size of the array.
...
Testcase 2: For second test case equilibrium point is at position 3 as elements below
it (1+3) = elements after it (2+2).
*/
...
int main() {
  ...
  while(t--) {
    ...
    cout << "Index of equilibrium point is : " << equilibriumPoint(arr,n) << endl;
  }
  return 0;
}
